...
@section('content')
    <div class="row m-0 p-0" style="background-color: wheat">
        {{-- Loading --}}
        <div id="loading"></div>
        {{--  End Transaksi  --}}
                    ...
                    <div class="row">
                        <div class="col-8">
                            <h2 class="card-title" style="font-size: 24px;">
                                <a href="{{ url('/') }}"><i class="fas fa-home" style="color: wheat"></i></a> DAFTAR
                                PRODUK
                            </h2>
                        </div>
                        <div class="col-4">
                ...
                <form id="frmTransaksi" action="{{ url('transaksi') }}" method="post">
                    ...
                    <div class="row member">
                        ...
                        <div class="col-md-2" style="text-align: end" data-bs-toggle="modal"
                            ...
                            <a class="btn btn-sm btn-warning"><i class="fas fa-ellipsis-h text-white"></i></a>
                        </div>
                    </div>
                    <p>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content" style="background-color: wheat">
                ...
                <div class="modal-body">
                    <table id="dtCustomer" class="dtTable table table-bordered table-hover table-warning">
                        <thead>
                            <tr>
                                <th scope="col">#</th>
